...
class PathWeighted
{
    ...
    static class Graph
    {
        ...
        public void addEdge(int v, int w, int weight)
        {
            ...
            // split all edges of weight 2 into two edges of weight 1 each. The intermediate
            // vertex number is maximum vertex number + 1, that is V.
            if (weight == 2)
            {
                adj[v].add(v + this.V);
                adj[v + this.V].add(w);
        ...
        // This function mainly does BFS and prints the shortest path from src to dest.
        // It is assumed that weight of every edge is 1
